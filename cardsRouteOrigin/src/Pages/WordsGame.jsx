  ...
  return (
    <div className={styles.words}>
      <div className={styles.learnedWords}>
        <Learned countLearnedWords={countLearnedWords} />
      </div>

      <button onClick={onPrevClick} className={styles.buttonList}>
        &#8592;
      </button>
      ...
      {isTranslateWord ? (
        <div className={styles.wordCard}>
          ...
          <button
            onClick={handleHideWordTranslate}
            className={styles.buttonWordTranslate}
          >
            Hide Translation
          </button>
        </div>
        ...
        <div className={styles.wordCard}>
          <span className={styles.wordTitle}>{wordCard.english}</span>
          <br></br>
          <button
            ref={ref}
            onClick={() => {
              handleWordTranslate(wordCard.id);
            }}
            className={styles.buttonWordTranslate}
          >
            Translation
      ...
      <button onClick={onNextClick} className={styles.buttonList}>
        &#8594;
      </button>

      <button onClick={handleAddWord} className={styles.buttonAddWord}>
        Add word
      </button>
    </div>
  );
